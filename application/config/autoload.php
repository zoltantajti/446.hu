...
$autoload['model'] = array('Misc','Sess','Cookie','Db','Banns','Logs','Seo','Navbar','User','Registration','GeoCoding','Encryption','Email','Msg','Visitor','Page','AdminForm', 'Markers','Events','News');
