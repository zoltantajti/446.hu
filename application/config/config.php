...
$config['csrf_exclude_uris'] = array(
	'Rest/setState','Rest/uploadFile','Rest/removeFile','Rest/addMarker','Rest/updateMarker','Rest/updateFreq','Rest/addFreq',
	'Rest/addTempMarker','Rest/addRestZone', 'Rest/saveError'
);