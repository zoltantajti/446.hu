...
! function() {
    ...
    const F = Array.prototype.slice,
        ...
        we = e => Ce(e, R),
        xe = (e, t) => Ee(e, t) ? I.from(e[t]) : I.none(),
        Ee = (e, t) => fe.call(e, t),
        _e = (e, t) => Ee(e, t) && void 0 !== e[t] && null !== e[t],
        ke = e => {
            const t = {};
            return V(e, (e => {
                t[e] = {}
        ...
        Re = (e, t, n) => {
            ...
            if (n = n || e, Se(e)) {
                ...
                for (const o in e)
                    if (Ee(e, o) && !1 === t.call(n, e[o], o, e)) return !1;
            return !0
        },
        Ae = (e, t) => {
            const n = [];
    ...
    const xt = () => wt(),
        ...
        Sn = e => yn(e.dom.ownerDocument),
        Nn = e => Yt(e) ? e : Sn(e),
        Rn = e => yn(Nn(e).dom.defaultView),
        An = e => I.from(e.dom.parentNode).map(yn),
        Tn = e => I.from(e.dom.parentElement).map(yn),
        On = (e, t) => {
            const n = w(t) ? t : L;
            let o = e.dom;
            const r = [];
        ...
        Pn = e => I.from(e.dom.nextSibling).map(yn),
        Dn = e => oe(wn(e, Bn)),
        Ln = e => wn(e, Pn),
    ...
    const Qn = (e, t, n) => {
        ...
        uo = (e, t) => so(e) ? e.style.getPropertyValue(t) : "",
        mo = (e, t) => {
            const n = e.dom,
                o = uo(n, t);
    ...
    const Ho = e => t => !!t && t.nodeType === e,
        $o = e => !!e && !Object.getPrototypeOf(e),
        qo = Ho(1),
        Vo = e => qo(e) && Vt(yn(e)),
        Wo = e => {
        ...
        Go = e => t => qo(t) && t.hasAttribute(e),
        Xo = e => qo(e) && e.hasAttribute("data-mce-bogus"),
        Qo = e => qo(e) && "TABLE" === e.tagName,
        Jo = e => t => {
            if (Vo(t)) {
        ...
        cr = Ko(["td", "th"]),
        ur = Ko(["td", "th", "caption"]),
        mr = Ko(["video", "audio", "object", "embed"]),
        fr = Wo("li"),
        gr = Wo("details"),
        pr = Wo("summary"),
        hr = "\ufeff",
        ...
        kr = xr(["ul", "ol", "dl"]),
        Sr = xr(["li", "dd", "dt"]),
        Nr = xr(["thead", "tbody", "tfoot"]),
        Rr = xr(["td", "th"]),
        Ar = xr(["pre", "script", "textarea", "style"]),
        Tr = () => {
            const e = bn("br");
        ...
        Fr = e => Mr(e) && Pr(e.data),
        Ur = e => Ir(e) || Fr(e),
        zr = e => e.firstChild !== e.lastChild || !ar(e.firstChild),
        jr = e => {
            const t = e.container();
        ...
        qr = e => Mr(e) && e.data[e.data.length - 1] === Br,
        ...
        Gr = ar,
        Xr = er,
        Qr = Ko(["script", "style", "textarea"]),
        Jr = Ko(["img", "input", "textarea", "hr", "iframe", "video", "audio", "object", "embed"]),
        Zr = Ko(["table"]),
        es = Ur,
        ts = e => !es(e) && (Xr(e) ? !Qr(e.parentNode) : Jr(e) || Gr(e) || Zr(e) || ns(e)),
        ...
        cs = Go("data-mce-bookmark"),
        us = Go("data-mce-bogus"),
        ms = ("data-mce-bogus", "all", e => qo(e) && "all" === e.getAttribute("data-mce-bogus"));
    const fs = e => Tn(yn(e)).exists((e => !oo(e))),
        gs = (e, t = !0) => ((e, t) => {
            let n = 0;
            if (ds(e, e)) return !1;
            {
        ...
        ps = e => "svg" === e.toLowerCase(),
        hs = e => ps(e.nodeName),
        bs = e => "svg" === (null == e ? void 0 : e.nodeName) ? "svg" : "html",
        vs = ["svg"],
        ys = "data-mce-block",
        ...
        xs = (e, t) => {
            const n = Cs(e.getTransparentElements()),
                o = Cs(e.getBlockElements());
        ...
        Es = (e, t) => {
            ...
            for (let t = e[o]; t; t = t[o])
                if (gs(yn(t))) return void(null === (n = t.parentNode) || void 0 === n || n.removeChild(t))
        },
        _s = (e, t, n) => {
        ...
        Ns = e => e.hasAttribute(ys),
        Rs = (e, t) => Ee(e.getTransparentElements(), t),
        As = (e, t) => qo(t) && Rs(e, t.nodeName),
        Ts = (e, t) => As(e, t) && Ns(t),
        Os = (e, t) => As(e, t) && !Ns(t),
        Bs = (e, t) => 1 === t.type && Rs(e, t.name) && m(t.attr(ys)),
        Ps = xt().browser,
        Ds = e => J(e, Wt),
        Ls = (e, t) => e.children && H(e.children, t),
        Ms = (e, t = {}) => {
            let n = 0;
            const o = {},
                r = yn(e),
        ...
        da = e => la("td th li dt dd figcaption caption details summary", e.getTextBlockElements()),
        ca = (e, t) => {
            if (e) {
                const n = {};
                return m(e) && (e = {
        ...
        ua = (e = {}) => {
            ...
            const c = ca(e.valid_styles),
                u = ca(e.invalid_styles, "map"),
                m = ca(e.valid_classes, "map"),
                ...
                v = i("non_empty_elements", b + " pre svg", p),
                ...
                _ = i("transparent_elements", "a ins del canvas map"),
                k = i("wrap_block_elements", "pre " + C);
        ...
        fa = e => (e => {
            ...
            var t
        })(ma(e.red) + ma(e.green) + ma(e.blue)),
        ga = /^\s*rgb\s*\(\s*(\d+)\s*,\s*(\d+)\s*,\s*(\d+)\s*\)\s*$/i,
        ...
        Ca = e => va(e).map(fa).map((e => "#" + e.value)).getOr(e),
        wa = (e = {}, t) => {
        ...
        bind(e, t, n, o) {
            ...
            for (; c--;) {
                let t = d[c],
                    ...
                    m = !1,
                    f = !1;
                "DOMContentLoaded" === t && (t = "ready"), r.domLoaded && "ready" === t && "complete" === e.readyState ? n.call(o, Ra({
                    type: t
                ...
                }), s = r.events[l][t], s ? "ready" === t && r.domLoaded ? n(Ra({
                    type: t
                })) : s.push({
                    func: n,
                    scope: o
    ...
    const Oa = Pt.each,
        ...
        Ma = e => e.replace(/[A-Z]/g, (e => "-" + e.toLowerCase())),
        Ia = (e, t) => {
            let n = 0;
            if (e)
        ...
        za = (e, t = {}) => {
            ...
            const a = Is.forElement(yn(e), {
                ...
                L = (t, n, o) => D(e.createElement(t), t, n, o, !0),
                M = ea.encodeAllRaw,
                I = (e, t) => O(e, (e => {
                    const n = yn(e);
                    return t && V(Mn(n), (e => {
    ...
    const $a = e => {
        ...
        Ka = {
            ...
            isRtl: () => Wa().bind((e => xe(e, "_dir"))).exists((e => "rtl" === e)),
            hasCode: e => Ee(qa, e)
        },
        Ya = () => {
            const e = [],
    ...
    const Ga = e => {
        ...
        Za = N("mce-annotation"),
        ei = N("data-mce-annotation"),
        ti = N("data-mce-annotation-uid"),
        ni = N("data-mce-annotation-active"),
        oi = N("data-mce-annotation-classes"),
        ri = N("data-mce-annotation-attrs"),
        si = e => t => _n(t, e),
        ai = (e, t) => {
        ...
        ii = (e, t) => nn(e, "data-mce-bogus") || zo(e, '[data-mce-bogus="all"]', si(t)),
        li = (e, t) => {
    ...
    const ui = e => {
        ...
        hi = (e, t) => {
            const n = t || (t => e.isBlock(t) || ar(t) || dr(t)),
                o = (e, t, n, r) => {
                    if (er(e)) {
        ...
        xi = (e, t) => e.top > t.bottom || !(e.bottom < t.top) && Ci(t.bottom - e.top, e, t),
        Ei = (e, t, n) => {
        ...
        Ni = e => m(e) && e.charCodeAt(0) >= 768 && Si.test(e),
        Ri = qo,
        Ai = ts,
        Ti = Yo("display", "block table"),
        Oi = Yo("float", "left right"),
        Bi = ((...e) => t => {
            for (let n = 0; n < e.length; n++)
                if (!e[n](t)) return !1;
            return !0
        })(Ri, Ai, O(Oi)),
        Pi = O(Yo("white-space", "pre pre-line pre-wrap")),
        Di = er,
        Li = ar,
        Mi = za.nodeIndex,
        Ii = (e, t) => t < 0 && qo(e) && e.hasChildNodes() ? void 0 : ki(e, t),
        Fi = e => e ? e.createRange() : za.DOM.createRng(),
        Ui = e => m(e) && /[\r\n\t ]/.test(e),
        zi = e => !!e.setStart && !!e.setEnd,
        ji = e => {
            const t = e.startContainer,
                n = e.startOffset;
        ...
        Hi = e => 0 === e.left && 0 === e.right && 0 === e.top && 0 === e.bottom,
        $i = e => {
            var t;
            let n;
    ...
    const Wi = (e, t) => {
        ...
        Zi = e => t => e === t,
        el = e => (Yi(e) ? "text()" : e.nodeName.toLowerCase()) + "[" + (e => {
            let t, n;
        ...
        tl = (e, t) => {
            ...
            if (Yi(r)) n = ((e, t) => {
                let n = e;
                for (;
                    (n = n.previousSibling) && Yi(n);) t += n.data.length;
                return t
            })(r, s);
            else {
        ...
        ul = (e, t) => {
            ...
            return Ki(n, o, c), e.moveToBookmark({
                id: r,
                keep: !0,
                forward: l
            }), {
    ...
    const bl = e => "inline-command" === e.type || "inline-format" === e.type,
        vl = e => "block-command" === e.type || "block-format" === e.type,
        yl = e => {
            const t = t => pl.error({
                    message: t,
                    pattern: e
        ...
        Tl = Nl("iframe_attrs"),
        Ol = Nl("doctype"),
        Bl = Nl("document_base_url"),
        Pl = Nl("body_id"),
        Dl = Nl("body_class"),
        Ll = Nl("content_security_policy"),
        Ml = Nl("br_in_pre"),
        Il = Nl("forced_root_block"),
        Fl = Nl("forced_root_block_attrs"),
        Ul = Nl("newline_behavior"),
        zl = Nl("br_newline_selector"),
        jl = Nl("no_newline_selector"),
        Hl = Nl("keep_styles"),
        $l = Nl("end_container_on_empty_block"),
        ql = Nl("automatic_uploads"),
        Vl = Nl("images_reuse_filename"),
        Wl = Nl("images_replace_blob_uris"),
        Kl = Nl("icons"),
        Yl = Nl("icons_url"),
        Gl = Nl("images_upload_url"),
        Xl = Nl("images_upload_base_path"),
        Ql = Nl("images_upload_credentials"),
        Jl = Nl("images_upload_handler"),
        Zl = Nl("content_css_cors"),
        ed = Nl("referrer_policy"),
        td = Nl("language"),
        nd = Nl("language_url"),
        od = Nl("indent_use_margin"),
        rd = Nl("indentation"),
        sd = Nl("content_css"),
        ad = Nl("content_style"),
        id = Nl("font_css"),
        ld = Nl("directionality"),
        dd = Nl("inline_boundaries_selector"),
        cd = Nl("object_resizing"),
        ud = Nl("resize_img_proportional"),
        md = Nl("placeholder"),
        fd = Nl("event_root"),
        gd = Nl("service_message"),
        pd = Nl("theme"),
        hd = Nl("theme_url"),
        bd = Nl("model"),
        vd = Nl("model_url"),
        yd = Nl("inline_boundaries"),
        Cd = Nl("formats"),
        wd = Nl("preview_styles"),
        xd = Nl("format_empty_lines"),
        Ed = Nl("format_noneditable_selector"),
        _d = Nl("custom_ui_selector"),
        kd = Nl("inline"),
        Sd = Nl("hidden_input"),
        Nd = Nl("submit_patch"),
        Rd = Nl("add_form_submit_trigger"),
        Ad = Nl("add_unload_trigger"),
        Td = Nl("custom_undo_redo_levels"),
        Od = Nl("disable_nodechange"),
        Bd = Nl("readonly"),
        Pd = Nl("editable_root"),
        Dd = Nl("content_css_cors"),
        Ld = Nl("plugins"),
        Md = Nl("external_plugins"),
        Id = Nl("block_unsupported_drop"),
        Fd = Nl("visual"),
        Ud = Nl("visual_table_class"),
        zd = Nl("visual_anchor_class"),
        jd = Nl("iframe_aria_text"),
        Hd = Nl("setup"),
        $d = Nl("init_instance_callback"),
        qd = Nl("urlconverter_callback"),
        Vd = Nl("auto_focus"),
        Wd = Nl("browser_spellcheck"),
        Kd = Nl("protect"),
        Yd = Nl("paste_block_drop"),
        Gd = Nl("paste_data_images"),
        Xd = Nl("paste_preprocess"),
        Qd = Nl("paste_postprocess"),
        Jd = Nl("newdocument_content"),
        Zd = Nl("paste_webkit_styles"),
        ec = Nl("paste_remove_styles_if_webkit"),
        tc = Nl("paste_merge_formats"),
        nc = Nl("smart_paste"),
        oc = Nl("paste_as_text"),
        rc = Nl("paste_tab_spaces"),
        sc = Nl("allow_html_data_urls"),
        ac = Nl("text_patterns"),
        ic = Nl("text_patterns_lookup"),
        lc = Nl("noneditable_class"),
        dc = Nl("editable_class"),
        cc = Nl("noneditable_regexp"),
        uc = Nl("preserve_cdata"),
        mc = Nl("highlight_on_focus"),
        fc = Nl("xss_sanitization"),
        gc = Nl("init_content_sync"),
        pc = e => Pt.explode(e.options.get("images_file_types")),
        hc = Nl("table_tab_navigation"),
        bc = Nl("details_initial_state"),
        vc = Nl("details_serialized_state"),
        yc = Nl("force_hex_color"),
        Cc = Nl("sandbox_iframes"),
        wc = qo,
        xc = er,
        Ec = e => {
            const t = e.parentNode;
        ...
        Nc = (e, t) => Vi.isTextPosition(t) ? ((e, t) => xc(e) && t.container() === e ? ((e, t) => {
            const n = _c(e.data.substr(0, t.offset())),
                o = _c(e.data.substr(t.offset()));
        ...
        Dc = () => At.browser.isFirefox(),
        Lc = e => Ac(e) || Tc(e),
        Mc = e => (Lc(e) || Qo(e) && Dc()) && Tn(yn(e)).exists(oo),
        Ic = lr,
        Fc = dr,
        Uc = mr,
        zc = Yo("display", "block table table-cell table-caption list-item"),
        jc = Ur,
        Hc = Ir,
        $c = qo,
        qc = er,
        ...
        Gc = (e, t, n, o, r) => {
            ...
            if (Kc(t)) {
                ...
                for (; i = Yc(s.prev.bind(s), r);)
                    if (n(i)) return i
            }
            if (Wc(t)) {
                if (a && (i = Yc(s.next.bind(s), !0), n(i))) return i;
                for (; i = Yc(s.next.bind(s), r);)
                    if (n(i)) return i
            }
            return null
        },
        ...
        Qc = (e, t, n) => Xc(e.container(), n) === Xc(t.container(), n),
        Jc = (e, t) => {
            if (!t) return I.none();
            const n = t.container(),
                o = t.offset();
        ...
        su = (e, t) => Jc(e ? 0 : -1, t).filter(Fc),
        au = (e, t, n) => {
            const o = ru(e, t, n);
            return -1 === e ? Vi.fromRangeStart(o) : Vi.fromRangeEnd(o)
        },
        iu = e => I.from(e.getNode()).map(yn),
        lu = (e, t) => {
            let n = t;
            for (; n = e(n);)
    ...
    const uu = dr,
        ...
        bu = os,
        vu = (e, t) => e.hasChildNodes() && t < e.childNodes.length ? e.childNodes[t] : null,
        yu = (e, t) => {
            if (Wc(e)) {
        ...
        wu = e => ({
            next: t => Cu(cu.Forwards, t, e),
            prev: t => Cu(cu.Backwards, t, e)
        }),
        xu = e => Vi.isTextPosition(e) ? 0 === e.offset() : ts(e.getNode()),
        Eu = e => {
        ...
        Nu = (e, t, n, o) => Su(e, t, n).bind((n => o(n) ? Nu(e, t, n, o) : I.some(n))),
        Ru = (e, t) => {
        ...
        Mu = e => Ee(e, "name"),
        Iu = e => Pt.isArray(e.start),
        Fu = e => !(!Mu(e) && b(e.forward)) || e.forward,
        ...
        Wu = (e, t) => {
            ((e, t) => {
                ...
                if (t) {
                    if (Iu(t)) return ((e, t) => {
                        const n = e.createRng();
                        return Hu(e, !0, t, n) && Hu(e, !1, t, n) ? I.some({
                            range: n,
                            forward: Fu(t)
                        }) : I.none()
                    })(n, t);
                    if ((e => m(e.start))(t)) return ((e, t) => {
                        const n = I.from(nl(e.getRoot(), t.start)),
                            o = I.from(nl(e.getRoot(), t.end));
                        return Mt(n, o, ((n, o) => {
                            const r = e.createRng();
    ...
    const Xu = e => "" !== e && -1 !== " \f\n\r\t\v".indexOf(e),
        ...
        em = e => Zu(Ju(e.selection.getSel()), yn(e.getBody())),
        tm = (e, t) => eo(e, "table", t),
        ...
        dm = e => x(null == e ? void 0 : e.nodeType),
        cm = e => qo(e) && !Ku(e) && !Du(e) && !Xo(e),
        um = (e, t, n) => {
            const {
                selection: o,
                dom: r
            } = e, s = o.getNode(), a = dr(s);
            lm(o, !0, (() => {
                t()
        ...
        Em = (e, t, n) => e.getParents(t, n, e.getRoot()),
        _m = (e, t, n) => {
        ...
        Im = (e, t, n) => Mm(e, t, n, (e => Yu(e) || Xu(e))),
        Fm = (e, t, n) => Mm(e, t, n, Qu),
        Um = (e, t, n, o, r, s) => {
            let a;
        ...
        jm = (e, t, n, o) => {
            ...
            if (s && km(i) && i.wrapper && (s = Bm(e, s, "ul,ol").reverse()[0] || s), !s)
                for (s = n; s && s[o] && !e.isBlock(s[o]) && (s = s[o], !ym(s, "br")););
            return s || n
        },
        Hm = (e, t, n, o) => {
        ...
        Wm = (e, t, n) => {
            ...
            const r = t.startOffset,
                s = ki(t.startContainer, r),
                a = t.endOffset,
                i = ki(t.endContainer, a - 1),
                l = e => {
                    const t = e[0];
    ...
    const Zm = (e, t, n) => !n.collapsed && $(n.getClientRects(), (n => ((e, t, n) => t >= e.left && t <= e.right && n >= e.top && n <= e.bottom)(n, e, t))),
        ...
        of = (e, t) => e.dispatch("SetContent", t),
        rf = (e, t) => e.dispatch("GetContent", t),
        sf = (e, t) => e.dispatch("PastePlainTextToggle", {
            state: t
        }),
        af = {
            BACKSPACE: 8,
        ...
        mf = (e, t) => {
            ...
            const x = e => C(e) && (ir(e) || n.is(e, "figure.image")),
                E = e => mr(e) || n.hasClass(e, "mce-preview-object"),
                _ = e => {
                    const n = e.target;
                    ((e, t) => {
    ...
    const bf = (e, t, n, o) => ({
        ...
        _f = (e, t) => {
            const n = e.fold(Cf.before, Ef, Cf.after),
                o = t.fold(Cf.before, Ef, Cf.after);
        ...
        Nf = e => {
            const t = xf.getWin(e).dom,
                n = (e, n, o, r) => gf(t, e, n, o, r),
                o = (e => e.match({
                    domRange: e => {
        ...
        Of = (e, t, n) => Tf(e, t, (e => e.nodeName === n)),
        Bf = (e, t) => Ur(e) && !Tf(e, t, Du),
        Pf = (e, t, n) => {
        ...
        Lf = (e, t, n, o) => {
            ...
            const d = qo(i) && l === i.childNodes.length,
        ...
        Ff = e => {
            ...
            if (t === o && er(t)) {
                if (n > 0 && n < t.data.length)
                    if (o = If(t, n), t = o.previousSibling, r > n) {
                        r -= n;
    ...
    const qf = e => "textarea" === Ht(e),
        ...
        tg = (e, t, n) => Wf(e, Zf, t, n),
        ng = (e, t, n) => Gf(e, t, Zf, n),
        og = (e, t, n) => Wf(e, eg, t, n),
        rg = (e, t, n) => Gf(e, t, eg, n),
        sg = (e, t, n) => {
            (e.inline ? tg : og)(e, t, n)
        },
        ag = (e, t = !1) => e.dom.focus({
            preventScroll: t
        }),
        ig = e => {
            const t = qn(e).dom;
        ...
        lg = (e = jf()) => I.from(e.dom.activeElement).map(yn),
        dg = (e, t) => {
            const n = Kt(t) ? Cr(t).length : Mn(t).length + 1;
            return e > n ? n : e < 0 ? 0 : e
        },
        cg = e => xf.range(e.start, dg(e.soffset, e.start), e.finish, dg(e.foffset, e.finish)),
        ug = (e, t) => !$o(t.dom) && (kn(e, t) || _n(e, t)),
        mg = e => t => ug(e, t.start) && ug(e, t.finish),
        fg = e => xf.range(yn(e.startContainer), e.startOffset, yn(e.endContainer), e.endOffset),
        gg = e => {
    ...
    const Cg = za.DOM,
        ...
        _g = (e, t) => {
            ...
            n.on("focusin", (() => {
                ...
                wg(Eg(n)) && o(n, un), t !== n && (t && t.dispatch("blur", {
                    focusedEditor: n
                ...
                vg.setEditorTimeout(n, (() => {
                    const t = e.focusedEditor;
                    wg(Eg(n)) && t === n || o(n, fn), xg(n, Eg(n)) || t !== n || (n.dispatch("blur", {
                        focusedEditor: null
                ...
                n && Kn(t).each((t => {
                    const o = t;
                    o.ownerDocument === document && (o === document.body || xg(n, o) || e.focusedEditor !== n || (n.dispatch("blur", {
                        focusedEditor: null
                    }), e.focusedEditor = null))
                }))
        ...
        Rg = e => e.inline ? (e => {
            ...
            var n, o
        })(e) : (e => C(e.iframeElement) && ig(yn(e.iframeElement)))(e),
        Ag = e => Rg(e) || (e => {
            const t = qn(yn(e.getElement()));
            return lg(t).filter((t => !wg(t.dom) && xg(e, t.dom))).isSome()
        })(e),
        Tg = e => e.editorManager.setActive(e),
        ...
        Dg = (e, t, n = !1) => Bg(e, t, !1, n, ((e, t) => t > 0 ? t - 1 : t)),
        Lg = (e, t) => {
            const n = e;
    ...
    const Kg = Pt.makeMap("NOSCRIPT STYLE SCRIPT XMP IFRAME NOEMBED NOFRAMES PLAINTEXT", " "),
        ...
        Jg = e => null !== Xg(e).nextNode(),
        Zg = e => null !== Qg(e).nextNode(),
        ep = (e, t) => null !== t.querySelector(Gg(e)),
        tp = (e, t) => {
        ...
        cp = e => {
            const t = [],
                n = (e = e || {}).indent,
                o = dp(e.indent_before || ""),
                r = dp(e.indent_after || ""),
                s = ea.getEncodeFunc(e.entity_encoding || "raw", e.entities),
                ...
                serialize: o => {
                    ...
                    const a = e => {
                        ...
                        if (i) i(e);
                            ...
                            if (n.start(s, l, i), ps(s)) m(e.value) && n.text(e.value, !0), n.end(s);
                            else if (!i) {
                                let t = e.firstChild;
                                if (t) {
    ...
    const fp = ["font", "text-decoration", "text-emphasis"],
        gp = (e, t) => me(e.parseStyle(e.getAttrib(t, "style"))),
        pp = (e, t, n) => {
            const o = gp(e, t),
                r = gp(e, n),
                s = o => {
        ...
        Cp = (e, t) => n => Jc(e ? 0 : -1, n).filter(t).isSome(),
        wp = e => ir(e) && "block" === co(yn(e), "display"),
        xp = e => dr(e) && !(e => qo(e) && "all" === e.getAttribute("data-mce-bogus"))(e),
        Ep = Cp(!0, wp),
        _p = Cp(!1, wp),
        kp = Cp(!0, mr),
        Sp = Cp(!1, mr),
        ...
        Bp = (e, t) => [e].concat(Op(e, t)),
        Pp = (e, t, n) => Nu(e, t, n, yp),
        ...
        jp = e => iu(e).exists(Er),
        Hp = (e, t, n, o) => {
            const r = Y(Bp(yn(n.container()), t), (e => o.isBlock(Ht(e)))),
                s = le(r).getOr(t);
        ...
        Vp = T(Hp, !1),
        Wp = T(Hp, !0),
        Kp = e => Vi.isTextPosition(e) && !e.isAtStart() && !e.isAtEnd(),
        Yp = (e, t, n) => {
        ...
        eh = (e, t, n) => !Qp(t) && (Ip(e, t, n) || Up(e, t, n) || qp(e, t, n) || Gp(e, t, n) || ((e, t) => {
            const n = Tu(e.dom, t).getOr(t),
                o = Jp(e.dom, "prev");
            return t.isAtStart() && (o(t.container()) || o(n.container()))
        })(e, t)),
        th = (e, t, n) => !Qp(t) && (Fp(e, t, n) || zp(e, t, n) || $p(e, t, n) || Xp(e, t, n) || ((e, t) => {
            const n = Au(e.dom, t).getOr(t),
                o = Jp(e.dom, "next");
            return t.isAtEnd() && (o(t.container()) || o(n.container()))
        })(e, t)),
        nh = (e, t, n) => eh(e, t, n) || th(e, (e => {
            const t = e.container(),
                n = e.offset();
            return er(t) && n < t.data.length ? Vi(t, n + 1) : e
        })(t), n),
        oh = (e, t) => Yu(e.charAt(t)),
        rh = (e, t) => Xu(e.charAt(t)),
        sh = (e, t, n, o) => {
            const r = t.data,
                s = Vi(t, 0);
        ...
        lh = (e, t, n, o) => {
            if (0 === n) return;
            const r = yn(e),
                s = Qn(r, (e => o.isBlock(Ht(e)))).getOr(r),
                a = e.data.slice(t, t + n),
                i = t + n >= e.data.length && th(s, Vi(e, e.data.length), o),
                l = 0 === t && eh(s, Vi(e, 0), o);
            e.replaceData(t, n, ls(a, 4, l, i))
        },
        dh = (e, t, n) => {
            const o = e.data.slice(t),
                r = o.length - We(o).length;
            lh(e, t, r, n)
        },
        ch = (e, t, n) => {
        ...
        })(t, e) ? Vi(t.container(), t.offset() - 1) : t,
        fh = e => {
        ...
        bh = (e, t) => t && Ee(e.schema.getBlockElements(), Ht(t)),
        vh = (e, t, n, o = !0, r = !1) => {
            const s = ph(t, e.getBody(), n.dom),
                a = Qn(n, T(bh, e), (i = e.getBody(), e => e.dom === i));
            var i;
            const l = ((e, t, n, o) => {
                const r = Bn(e).filter(Kt),
                    s = Pn(e).filter(Kt);
        ...
        yh = /[\u0591-\u07FF\uFB1D-\uFDFF\uFE70-\uFEFC]/,
        Ch = (e, t) => xn(yn(t), dd(e)) && !Ts(e.schema, t) && e.dom.isEditable(t),
        wh = e => {
            var t;
        ...
        Nh = e => Sh(e, "Delete"),
        Rh = e => _r(e) || Sr(e),
        Ah = (e, t) => kn(e, t) ? Jn(t, Rh, (e => t => Dt(An(t), e, _n))(e)) : I.none(),
        Th = (e, t = !0) => {
        ...
        zh = (e, t) => no(yn(e), "td,th", t),
        jh = e => !_n(e.start, e.end),
        Hh = (e, t) => tm(e.start, t).bind((n => tm(e.end, t).bind((e => It(_n(n, e), n))))),
        $h = e => t => Hh(t, e).map((e => ((e, t, n) => ({
            rng: e,
            table: t,
            cells: n
        }))(t, e, Mh(e)))),
        qh = (e, t, n, o) => {
            ...
            if (t.isSameTable) {
                ...
                const e = zh(n.startContainer, o),
                    t = zh(n.endContainer, o),
        ...
        Yh = (e, t) => {
            const n = (e => t => _n(e, t))(e),
                o = ((e, t) => {
                    const n = zh(e.startContainer, t),
                        o = zh(e.endContainer, t);
                    return Mt(n, o, Fh)
                })(t, n),
                r = ((e, t) => {
                    const n = Ih(e.startContainer, t),
                        o = Ih(e.endContainer, t),
                        r = n.isSome(),
                        s = o.isSome(),
                        a = Mt(n, o, _n).getOr(!1);
                    return (e => Mt(e.startTable, e.endTable, ((t, n) => {
                        const o = Lh(t, (e => _n(e, n))),
                            r = Lh(n, (e => _n(e, t)));
                        return o || r ? {
                            ...e,
            ...
            return ((e, t, n) => e.exists((e => ((e, t) => !jh(e) && Hh(e, t).exists((e => {
            ...
            })))(e, n) && rm(e.start, t))))(o, t, n) ? o.map((e => Uh.singleCellTable(t, e.start))) : r.isMultiTable ? ((e, t, n, o) => qh(e, t, n, o).bind((({
                start: e,
                end: o
            }) => {
                const r = e.bind(Wh).getOr([]),
                    s = o.bind(Wh).getOr([]);
                ...
                return I.none()
            })))(o, r, t, n) : ((e, t, n, o) => qh(e, t, n, o).bind((({
                start: e,
                end: t
            }) => e.or(t))).bind((e => {
                const {
                ...
                if (r.length > 0) {
                    ...
                    {
                        const e = Kh(n, t);
                        return I.some(Uh.partialTable(r, I.some({
                            ...t,
                            rng: e
                        })))
                    }
        ...
        Zh = (e, t, n, o) => I.some((() => {
            ...
            const i = gs(s) ? t : t.slice(1),
                l = gs(a) ? n : n.slice(0, -1);
            Gh(i.concat(l)), o.deleteContents(), Qh(e)
        })),
        eb = (e, t, n, o = !0) => I.some((() => {
            Ph(e, t, n, o)
        })),
        tb = (e, t) => I.some((() => vh(e, !1, t))),
        nb = (e, t) => J(Bp(t, e), Rr),
        ob = (e, t) => J(Bp(t, e), Xt("caption")),
        rb = (e, t) => I.some((() => {
        ...
        db = ["data-ephox-", "data-mce-", "data-alloy-", "data-snooker-", "_"],
        cb = Pt.each,
        ub = e => {
            const t = e.dom,
                n = new Set(e.serializer.getTempAttrs()),
                o = e => $(db, (t => He(e, t))) || n.has(e);
            return {
                compare: (e, n) => {
        ...
        mb = e => ["h1", "h2", "h3", "h4", "h5", "h6"].includes(e.name),
        fb = (e, t, n, o) => {
            const r = n.name;
        ...
        wb = (e, t, n, o = _) => {
            const r = t.getTextBlockElements(),
                ...
                i = Pt.makeMap("tr,td,th,tbody,thead,tfoot,table,summary"),
                l = new Set,
                d = e => e !== n && !i[e.name];
            for (let n = 0; n < e.length; n++) {
                const i = e[n];
            ...
            return ((e, t) => {
                ...
                if (t) {
                    ...
                    Pt.each(o.select("*[data-mce-fragment]"), (e => {
                        if (C(n[e.nodeName.toLowerCase()]) && ((e, t) => ne(gp(e, t), (e => !(e => mp.has(e))(e))))(o, e))
                            for (let n = e.parentElement; C(n) && n !== t && !pp(o, e, n); n = n.parentElement)
                                if (r.compare(n, e)) {
                                    o.remove(e, !0);
                                    break
                                }
            ...
            if (a)
                if (Se(a)) {
                    for (let n = 0; n < a.length; n++)
                        if (i ? e.getAttrib(t, a[n]) : wm(e, t, a[n])) return !0
                } else
                    for (const o in a)
                        if (Ee(a, o)) {
                            const l = i ? e.getAttrib(t, o) : wm(e, t, o),
                                d = vm(a[o], s),
                                c = y(l) || Ge(l);
                            if (c && y(d)) continue;
            ...
            if (s && qo(t))
                for (let n = 0; n < s.length; n++) {
                    ...
                    if (Ub(e.dom, t, i) && zb(a, t, i, "attributes", r, o) && zb(a, t, i, "styles", r, o)) {
                        ...
                        if (n)
                            for (let r = 0; r < n.length; r++)
                                if (!e.dom.hasClass(t, vm(n[r], o))) return;
                        return i
                    }
                }
        },
        ...
        Kb = (e, t, n) => {
            const o = e.dom,
                r = e.selection;
            if (t) Wb(e, t, n);
            else if (!(t = Lu(e.getBody(), r.getStart())))
                for (; t = o.get(Pu);) Wb(e, t, n)
        },
        Yb = (e, t) => (e.appendChild(t), t),
        Gb = (e, t) => {
            var n;
        ...
        Xb = (e, t, n, o) => {
            ...
            if (h)
                if (l) {
                    ...
                    const l = Lu(e.getBody(), h),
                        d = C(l) ? a.getParents(h.parentNode, M, l) : [],
                        c = Vb(!1).dom;
                    ((e, t, n) => {
                        var o, r;
                        const s = e.dom,
                            a = s.getParent(n, T(gm, e.schema));
                    ...
                    const u = ((e, t, n, o, a, i) => {
                            const l = e.formatter,
                                d = e.dom,
                                c = Y(me(l.get()), (e => e !== o && !je(e, "removeformat"))),
                                u = ((e, t, n) => X(n, ((n, o) => {
    ...
    const nv = ["fontWeight", "fontStyle", "color", "fontSize", "fontFamily"],
        ov = (e, t) => {
            const n = e.get(t);
        ...
        av = e => t => fr(t) && e.isEditable(t),
        iv = e => Y(e.getSelectedBlocks(), av(e.dom)),
        lv = Pt.each,
        dv = e => qo(e) && !Ku(e) && !Du(e) && !Xo(e),
        cv = (e, t) => {
            for (let n = e; n; n = n[t]) {
        ...
        uv = (e, t, n) => {
            const o = ub(e),
                r = Vo(t) && e.dom.isEditable(t),
                s = Vo(n) && e.dom.isEditable(n);
            if (r && s) {
                const r = cv(t, "previousSibling"),
                    s = cv(n, "nextSibling");
                if (o.compare(r, s)) {
        ...
        vv = Pt.each,
        yv = ym,
        Cv = (e, t, n) => e.isChildOf(t, n) && t !== n && !e.isBlock(n),
        wv = (e, t, n) => {
                ...
                const s = e.formatter.get(t),
                    ...
                    u = t => {
                        const n = ce(t.childNodes),
                            o = c(t) || $(s, (e => Ub(i, t, e))),
                            r = t.parentNode;
                        if (!o && C(r) && Rm(a) && c(r), a.deep && n.length)
        ...
        Bv = (e, t, n, o, r) => Av(e, t, n, o, r).fold(L, (t => (e.dom.rename(o, t), !0)), M),
        Pv = Pt.each,
        Dv = Pt.each,
        Lv = (e, t, n, o) => {
            if (Dv(n.styles, ((n, r) => {
            ...
            if (s) {
                if (o)
                    ...
                    V((e => Y((e => {
                        ...
                        {
                            const e = le(t).filter((e => rv(n, e))).toArray(),
                                o = de(t).filter((e => sv(n, e))).toArray(),
                                r = t.slice(1, -1);
        ...
        Fv = e => Ee(e, "vars"),
        Uv = e => e.selection.getStart(),
        zv = (e, t, n, o, r) => Q(t, (t => {
            const s = e.formatter.matchNode(t, n, null != r ? r : {}, o);
            return !v(s)
        }), (t => !!Ib(e, t, n) || !o && C(e.formatter.matchNode(t, n, r, !0)))),
        jv = (e, t) => {
        ...
        Hv = (e, t, n) => {
            ...
            ge(n, ((n, r) => {
                const s = n => {
                    const s = zv(e, o, r, n.similar, Fv(n) ? n.vars : void 0),
                        a = s.isSome();
                    if (n.state.get() !== a) {
                        n.state.set(a);
                        const e = s.getOr(t);
        ...
        Wv = (e, t, n) => {
            t.addNodeFilter("br", ((t, o, r) => {
                const s = Pt.extend({}, n.getBlockElements()),
    ...
    const my = _y(Array.prototype.forEach),
        fy = _y(Array.prototype.pop),
        gy = _y(Array.prototype.push),
        py = _y(String.prototype.toLowerCase),
        hy = _y(String.prototype.toString),
        by = _y(String.prototype.match),
        vy = _y(String.prototype.replace),
        yy = _y(String.prototype.indexOf),
        Cy = _y(String.prototype.trim),
        wy = _y(RegExp.prototype.test),
        xy = (Ey = TypeError, function() {
    ...
    var Xy = function e() {
        ...
        const {
            ...
            DOMParser: f,
            trustedTypes: g
        } = t, p = d.prototype, h = Ny(p, "cloneNode"), b = Ny(p, "nextSibling"), v = Ny(p, "childNodes"), y = Ny(p, "parentNode");
        ...
        const xe = s.createElement("form"),
            ...
            Ne = ky({}, ["title", "style", "font", "a", "script"]),
            Re = ky({}, Ay);
        ky(Re, Ty), ky(Re, Oy);
        const Ae = ky({}, By);
        ky(Ae, Py);
        const Te = function(e) {
            ...
            Me = function(e) {
                ...
                }(e) ? (Te(e), !0) : "noscript" !== r && "noembed" !== r && "noframes" !== r || !wy(/<\/no(script|embed|frames)/i, e.innerHTML) ? (K && 3 === e.nodeType && (t = e.textContent, t = vy(t, R, " "), t = vy(t, A, " "), t = vy(t, T, " "), e.textContent !== t && (gy(n.removed, {
                    element: e.cloneNode()
            ...
            Ie = function(e, t, n) {
                ...
                else if ("src" !== t && "xlink:href" !== t && "href" !== t || "script" === e || 0 !== yy(n, "data:") || !ie[e])
                    if (V && !wy(P, vy(n, D, "")));
                    else if (n) return !1;
                return !0
            },
        ...
        return n.sanitize = function(e) {
            ...
            if (Q) {
                if (J)
                    for (i = _.call(t.ownerDocument); t.firstChild;) i.appendChild(t.firstChild);
                else i = t;
    ...
    const rC = Pt.makeMap("src,href,data,background,action,formaction,poster,xlink:href"),
        sC = "data-mce-type";
    let aC = 0;
    const iC = (e, t, n, o, r) => {
            var s, a, i, l;
        ...
        hC = (e, t, n, o) => {
            ...
            for (let t = 0, r = a.length; t < r; t++) {
                const r = a[t],
                    i = new Wg(r.nodeName.toLowerCase(), r.nodeType);
                if (qo(r)) {
        ...
        bC = (e = {}, t = ua()) => {
            const n = qv(),
                ...
                g = (e, n) => {
                    const o = m(n.attr(sC)),
                        r = 1 === n.type && !Ee(e, n.name) && !Bs(t, n) && !ps(n.name);
                    return 3 === n.type || r && !o
                },
                p = {
                    schema: t,
                    ...
                    parse: (e, n = {}) => {
                        ...
                        const i = r.validate,
                            ...
                            c = ((e, n, o = "html") => {
                                const r = "xhtml" === o ? "application/xhtml+xml" : "text/html",
                                    i = Ee(t.getSpecialElements(), n.toLowerCase()),
                                    l = i ? `<${n}>${e}</${n}>` : e,
                        ...
                        const [f, p] = ((e, t, n, o) => {
                            const r = n.validate,
                                s = t.getNonEmptyElements(),
                                a = t.getWhitespaceElements(),
                                i = pC(gC("script,style,head,html,body,title,meta,param"), t.getBlockElements()),
                                l = da(t),
                                d = /[ \t\r\n]+/g,
                                c = /^[ \t\r\n]+/,
                                u = /[ \t\r\n]+$/,
                                ...
                                f = n => n.name in i || Bs(t, n) || ps(n.name) && n.parent === e,
                                g = (t, n) => {
        ...
        yC = (e, t) => {
            if (t.no_events) return pl.value(t);
            {
                ...
                return n.isDefaultPrevented() ? pl.error(rf(e, {
                    content: "",
                    ...n
                }).content) : pl.value(n)
            }
        ...
        SC = (e, t) => tn(e, t).bind(Xe).getOr(1),
        NC = (e, t, n) => {
            const o = e.rows;
            return !!(o[n] ? o[n].cells : [])[t]
        },
        RC = e => X(e, ((e, t) => t.cells.length > e ? t.cells.length : e), 0),
        AC = (e, t) => {
            const n = e.rows;
            for (let e = 0; e < n.length; e++) {
                const o = n[e].cells;
                for (let n = 0; n < o.length; n++)
                    if (_n(o[n], t)) return I.some(kC(n, e))
            }
            return I.none()
        },
        TC = (e, t, n, o, r) => {
        ...
        BC = (e, t, n) => {
            const o = yn(t.commonAncestorContainer),
                r = Bp(o, e),
                s = Y(r, (e => n.isWrapper(Ht(e)))),
                a = ((e, t) => J(e, (e => "li" === Ht(e) && rm(e, t))).fold(N([]), (t => (e => J(e, (e => "ul" === Ht(e) || "ol" === Ht(e))))(e).map((e => {
                    const t = bn(Ht(e)),
                        n = ye(fo(e), ((e, t) => He(t, "list-style")));
        ...
        PC = () => Sf([]),
        DC = (e, t) => ((e, t) => eo(t, "table", T(_n, e)))(e, t[0]).bind((e => {
            const n = t[0],
                o = t[t.length - 1],
                r = (e => {
                    const t = EC(fi(e), 0, []);
        ...
        MC = (e, t) => t >= 0 && t < e.length && Xu(e.charAt(t)),
        IC = e => Dr(e.innerText),
        ...
        })(q(ce(t.childNodes), FC), e), t), t),
        zC = De((() => document.implementation.createHTMLDocument("undo"))),
        jC = e => {
        ...
        $C = e => "fragmented" === e.type ? e.fragments.join("") : e.content,
        qC = e => {
            const t = bn("body", zC());
        ...
        GC = e => ({
            ...
            undoManager: {
                ...
                undo: (t, n, o) => ((e, t, n, o) => {
                    let r;
                    return t.typing && (t.add(), t.typing = !1, KC(t, !1, n)), o.get() > 0 && (o.set(o.get() - 1), r = t.data[o.get()], HC(e, r, !0), e.setDirty(!0), e.dispatch("Undo", {
                        level: r
                    })), r
                })(e, t, n, o),
                redo: (t, n) => ((e, t, n) => {
                    let o;
                    return t.get() < n.length - 1 && (t.set(t.get() + 1), o = n[t.get()], HC(e, o, !1), e.setDirty(!0), e.dispatch("Redo", {
                        level: o
                    })), o
                })(e, t, n),
                clear: (t, n) => ((e, t, n) => {
            ...
            editor: {
                ...
                setContent: (t, n) => ((e, t, n) => I.from(e.getBody()).map((o => Bb(t) ? ((e, t, n, o) => {
                    ...
                    const r = up({
                        ...
                        s = Dr(Ar(yn(t)) ? r : Pt.trim(r));
                    return Pb(e, s, o.no_selection), {
                        content: n,
                        html: s
                    }
                })(e, o, t, n) : ((e, t, n, o) => {
                        ...
                        const n = ((e, t) => {
                            if ("text" === t.format) return (e => I.from(e.selection.getRng()).map((t => {
                                ...
                                const i = e.dom.add(r, s, {
                                    ...
                                    l = IC(i),
                                    d = Dr(null !== (n = i.textContent) && void 0 !== n ? n : "");
            ...
            autocompleter: {
                addDecoration: t => zg(e, t),
                removeDecoration: () => ((e, t) => jg(t).each((t => {
                    const n = e.selection.getBookmark();
        ...
        XC = e => Ee(e.plugins, "rtc"),
        QC = e => e.rtcInstance ? e.rtcInstance : GC(e),
        JC = e => {
            const t = e.rtcInstance;
            if (t) return t;
            throw new Error("Failed to get RTC instance not yet initialized.")
        },
        ZC = e => JC(e).init.bindEvents(),
        ew = e => 0 === e.dom.length ? (xo(e), I.none()) : I.some(e),
        tw = (e, t, n, o, r) => {
    ...
    const ow = e => !(!e || !e.ownerDocument) && kn(yn(e.ownerDocument), yn(e)),
        rw = (e, t, n, o) => {
            let r, s;
            const {
                ...
                wC(e, o).each((t => {
                    ...
                    ((e, t, n) => {
                        const o = I.from(t.firstChild).map(yn),
                            r = I.from(t.lastChild).map(yn);
                        e.deleteContents(), e.insertNode(t);
                        const s = o.bind(Bn).filter(Kt).bind(ew),
                            a = r.bind(Pn).filter(Kt).bind(ew);
                ...
                getSelectedBlocks: (t, n) => ((e, t, n, o) => {
                    const r = [],
                        s = e.getRoot(),
                        a = e.getParent(n || Pg(s, t, t.collapsed), e.isBlock),
        ...
        aw = (e, t) => {
            const n = ["data-mce-selected"],
                ...
                r = t && t.dom ? t.dom : za.DOM,
                s = t && t.schema ? t.schema : ua(o),
                a = bC(o, s);
            return ((e, t, n) => {
        ...
        pw = e => fw(e, cw),
        hw = (e, t) => {
            const n = Pt.makeMap(e.plugins, " "),
                o = Y(t, (e => Ee(n, e)));
            return ae(o)
        },
        bw = e => hw(e, uw),
        vw = e => hw(e, mw.map((e => e.name))),
        yw = e => J(mw, (t => t.name === e)).fold((() => e), (t => t.replacedWith ? `${e}, replaced by ${t.replacedWith}` : e)),
        Cw = za.DOM,
        ww = e => I.from(e).each((e => e.destroy())),
        xw = (() => {
            const e = {};
            return {
                add: (t, n) => {
        ...
        Ew = Ya.ModelManager,
        _w = (e, t) => t.dom[e],
        kw = (e, t) => parseInt(co(t, e), 10),
        Sw = T(_w, "clientWidth"),
        Nw = T(_w, "clientHeight"),
        Rw = T(kw, "margin-top"),
        Aw = T(kw, "margin-left"),
        Tw = e => {
            const t = [],
            ...
            return {
                findAll: (o, r = M) => {
                    const s = Y((e => e ? ce(e.getElementsByTagName("img")) : [])(o), (t => {
                        ...
                        a = q(s, (e => {
                            const o = e.src;
                            if (Ee(n, o)) return n[o].then((t => m(t) ? t : {
                                image: e,
                                blobInfo: t.blobInfo
                            }));
                            {
                                    ...
                                    if (He(t, "blob:")) {
                                        ...
                                        return C(s) ? Promise.resolve(s) : (o = t, He(o, "blob:") ? (e => fetch(e).then((e => e.ok ? e.blob() : Promise.reject())).catch((() => Promise.reject({
                                            ...
                                            Kv(r).bind((({
                                                ...
                                                data: t,
                                                base64Encoded: n
                                            }) => Yv(e, t, n))).fold((() => t("Invalid data URI")), e)
    ...
    const qw = (e, t) => {
        ...
        lx = "data-mce-placeholder",
        dx = e => "keydown" === e.type || "keyup" === e.type,
        cx = e => {
            const t = e.keyCode;
        ...
        mx = (e, t) => {
            const n = yn(e),
                o = yn(t.container());
            return Ah(n, o).map((e => ((e, t) => ({
                block: e,
                position: t
            }))(e, t)))
        },
        fx = (e, t) => Jn(t, (e => Rr(e) || lr(e.dom)), (t => _n(t, e))).filter(Wt).getOr(e),
        gx = (e, t) => {
            const n = ((e, t) => {
                const n = Mn(e);
        ...
        Cx = (e, t, n, o, r) => t ? yx(e, o, n, r) : yx(e, n, o, r),
        wx = (e, t) => {
            const n = yn(e.getBody()),
        ...
        Ex = e => {
            ...
            return ((e, t) => {
                const n = Tu(e.dom, Vi.fromRangeStart(t)).isNone(),
                    o = Au(e.dom, Vi.fromRangeEnd(t)).isNone();
        ...
        Nx = (e, t, n) => t.collapsed ? ((e, t, n) => {
            const o = ru(1, e.getBody(), t),
                r = Vi.fromRangeStart(o),
                s = r.getNode();
        ...
        Ox = (e, t) => ((e, t) => {
            ...
            const o = t ? cu.Forwards : cu.Backwards,
                r = wu(e.getBody()),
                s = T(lu, t ? r.next : r.prev),
                a = t ? Rx : Ax,
                i = au(o, e.getBody(), n),
                l = s(i),
                d = l ? Eh(t, l) : l;
        ...
        Mx = (e, t) => I.from(lb(e.getBody(), t)),
        Ix = (e, t) => {
            const n = e.selection.getNode();
            return Mx(e, n).filter(dr).fold((() => ((e, t, n, o) => {
                const r = ru(t ? 1 : -1, e, n),
                    s = Vi.fromRangeStart(r),
                    a = yn(e);
        ...
        zx = (e, t) => e.selection.isCollapsed() ? ((e, t) => {
            const n = Vi.fromRangeStart(e.selection.getRng());
            return ku(t, e.getBody(), n).filter((e => t ? Ep(e) : _p(e))).bind((e => Jc(t ? 0 : -1, e))).map((t => () => e.selection.select(t)))
        })(e, t) : I.none(),
        jx = er,
        Hx = e => jx(e) && e.data[0] === Br,
        $x = e => jx(e) && e.data[e.data.length - 1] === Br,
        qx = e => {
            var t;
        ...
        Wx = T(Vx, !0),
        Kx = T(Vx, !1),
        Yx = (e, t) => er(e.container()) ? Vx(t, e.container()) : Vx(t, e.getNode()),
        Gx = (e, t) => {
            const n = t.get();
        ...
        tE = (e, t) => null === Lu(e, t),
        nE = (e, t, n) => xh(e, t, n).filter(T(tE, t)),
        oE = (e, t, n) => {
            const o = kh(n);
        ...
        aE = e => !wh(lE(e)),
        iE = (e, t, n) => Qx([eE, oE, rE, sE], [e, t, n]).filter(aE),
        lE = e => e.fold(R, R, R, R),
        ...
        mE = (e, t, n, o, r, s) => Mt(xh(t, n, o), xh(t, n, r), ((t, o) => t !== o && ((e, t, n) => {
            const o = Xc(t, e),
                r = Xc(n, e);
            return C(o) && o === r
        })(n, t, o) ? Jx.after(e ? t : o) : s)).getOr(s),
        fE = (e, t) => e.fold(M, (e => {
    ...
    const bE = (e, t) => e === cu.Backwards ? oe(t) : t,
        vE = (e, t, n) => e === cu.Forwards ? t.next(n) : t.prev(n),
        ...
        EE = (e, t) => le(t.getClientRects()).bind((t => xE(e, t.left))),
        _E = T(CE, Vi.isAbove, -1),
        kE = T(CE, Vi.isBelow, 1),
        SE = T(wE, -1, _E),
        NE = T(wE, 1, kE),
        RE = (e, t) => _E(e, t).breakAt.isNone(),
        AE = (e, t) => kE(e, t).breakAt.isNone(),
        TE = (e, t) => EE(SE(e, t), t),
        OE = (e, t) => EE(NE(e, t), t),
        BE = dr,
        PE = (e, t) => Math.abs(e.left - t),
        DE = (e, t) => Math.abs(e.right - t),
        LE = (e, t) => Oe(e, ((e, n) => {
            const o = Math.min(PE(e, t), DE(e, t)),
                r = Math.min(PE(n, t), DE(n, t));
    ...
    const UE = (e, t, n, o, r, s) => {
        ...
        zE = T(UE, FE.Up, wi, xi),
        jE = T(UE, FE.Down, xi, wi),
        HE = e => Pe(e.getClientRects()),
        $E = e => t => ((e, t) => t.line > e)(e, t),
        qE = e => t => ((e, t) => t.line === e)(e, t),
        VE = (e, t) => {
            e.selection.setRng(t), sg(e, e.selection.getRng())
        },
        WE = (e, t, n) => I.some(Nx(e, t, n)),
        KE = (e, t, n, o, r, s) => {
            const a = t === cu.Forwards,
                i = wu(e.getBody()),
                l = T(lu, a ? i.next : i.prev),
                d = a ? o : r;
            if (!n.collapsed) {
                const o = _i(n);
        ...
        YE = (e, t, n, o, r, s) => {
            const a = au(t, e.getBody(), n),
                i = Pe(a.getClientRects()),
                l = t === FE.Down,
                d = e.getBody();
            if (!i) return I.none();
            if (Px(e)) {
        ...
        GE = (e, t) => {
            const n = e.selection.getRng(),
                o = t ? Vi.fromRangeEnd(n) : Vi.fromRangeStart(n),
        ...
        XE = (e, t, n) => GE(e, t).filter(n).exists((t => (e.selection.setRng(t.toRange()), !0))),
        QE = (e, t) => {
        ...
        ZE = (e, t, n) => Xx(t, n).map((t => (QE(e, t), n))),
        e_ = (e, t, n) => {
            const o = e.getBody(),
                r = ((e, t, n) => {
        ...
        t_ = (e, t, n) => !!yd(e) && e_(e, t, n).isSome(),
        n_ = (e, t, n) => !!yd(t) && ((e, t) => {
            const n = t.selection.getRng(),
                o = e ? Vi.fromRangeEnd(n) : Vi.fromRangeStart(n);
        ...
        o_ = e => {
            ...
            return e.on("NodeChange", (o => {
                yd(e) && (((e, t, n) => {
                    const o = q(Uo(yn(t.getRoot()), '*[data-mce-selected="inline-boundary"]'), (e => e.dom)),
                        r = Y(o, e),
                        s = Y(n, e);
        ...
        d_ = (e, t, n) => {
            if (e.selection.isCollapsed() && yd(e)) {
                const o = Vi.fromRangeStart(e.selection.getRng());
                return ((e, t, n, o) => {
                    const r = ((e, t) => Xc(t, e) || e)(e.getBody(), o.container()),
                        s = T(Ch, e),
                        a = iE(s, r, o);
        ...
        y_ = (e, t) => Qn(e, (e => Du(e.dom)), (e => t.isBlock(Ht(e)))).isSome(),
        C_ = e => ((e => {
            const t = e.selection.getRng();
        ...
        R_ = (e, t) => {
            ...
            const {
                dom: r
            } = e, s = rd(e), a = null !== (o = null === (n = /[a-z%]+$/i.exec(s)) || void 0 === n ? void 0 : n[0]) && void 0 !== o ? o : "px", i = E_(s), l = od(e);
            V(N_(e), (e => {
                ((e, t, n, o, r, s) => {
                    const a = __(n, yn(s)),
                        i = E_(e.getStyle(s, a));
        ...
        z_ = e => t => -1 !== (" " + t.attr("class") + " ").indexOf(e),
        j_ = (e, t, n) => function(o) {
            const r = arguments,
                s = r[r.length - 2],
                a = s > 0 ? t.charAt(s - 1) : "";
        ...
        q_ = dr,
        V_ = (e, t, n) => {
            const o = wu(e.getBody()),
                r = T(lu, 1 === t ? o.next : o.prev);
            if (n.collapsed) {
        ...
        nk = (e, t) => J(((e, t) => te((e => q(e, (e => ({
            ...Z_,
            ...e
        }))))(e), (e => ek(e, t) ? [e] : [])))(e, t), (e => e.action())),
        ok = (e, t) => ue(((e, t) => te((e => q(e, (e => ({
            ...Z_,
            ...e
        }))))(e), (e => ek(e, t) ? [e] : [])))(e, t), (e => e.action())),
        rk = (e, t) => {
        ...
        dk = (e, t, n) => te(Mn(e), (e => xn(e, t) ? n(e) ? [e] : [] : dk(e, t, n))),
        ck = (e, t) => no(e, "table", t),
        uk = (e, t, n, o, r = M) => {
            const s = 1 === o;
        ...
        mk = (e, t) => ck(e, t).bind((t => {
            ...
            return Z(n, (t => _n(e, t))).map((e => ({
                index: e,
                all: n
            })))
        })),
        fk = (e, t, n, o, r) => {
            const s = Uo(yn(n), "td,th,caption").map((e => e.dom)),
                a = Y(((e, t) => te(t, (t => {
                    const n = ((e, t) => ({
                        left: e.left - t,
                        top: e.top - t,
        ...
        gk = T(fk, (e => e.bottom), ((e, t) => e.y < t)),
        pk = T(fk, (e => e.top), ((e, t) => e.y > t)),
        hk = (e, t, n) => {
            const o = e(t, n);
        ...
        Ek = (e, t) => xk(e, t, yk),
        _k = (e, t) => xk(e, t, wk),
        kk = (e, t, n) => n.fold(I.none, I.none, ((e, t) => {
        ...
        Mk = e => Dr(e.toString().replace(/\u00A0/g, " ")),
        Ik = e => "" !== e && -1 !== " \xa0\f\n\r\t\v".indexOf(e),
        Fk = (e, t) => e.substring(t.length),
        Uk = (e, t, n, o = 0) => {
    ...
    const qk = (e, t, n) => e.stype === $k.Error ? t(e.serror) : n(e.svalue),
        Vk = e => ({
            stype: $k.Value,
            svalue: e
        }),
        ...
        oS = nS(Vk),
        rS = (e, t, n, o) => o(xe(e, t).getOrThunk((() => n(e)))),
        sS = (e, t, n, o, r) => {
            const s = e => r.extract(t.concat([o]), e),
                a = e => e.fold((() => Vk(I.none())), (e => {
                    const n = r.extract(t.concat([o]), e);
                    return s = n, a = I.some, s.stype === $k.Value ? {
                        stype: $k.Value,
                        svalue: a(s.svalue)
                    } : s;
                    var s, a
    ...
    const HS = [IS, DS, PS, BS, OS],
        ...
        WS = $S.concat([US("contextformbutton"), FS, TS, bS("original", R)]),
        KS = HS.concat([US("contextformbutton")]),
        YS = $S.concat([US("contextformtogglebutton")]),
        GS = dS("type", {
            contextformbutton: VS,
    ...
    const XS = e => {
            const t = e.ui.registry.getAll().popups,
                n = pe(t, (e => {
                    return (t = e, lS("Autocompleter", zS, {
                        trigger: t.ch,
                        ...t
                    })).fold((e => {
        ...
        JS = xt().browser.isSafari(),
        ZS = e => Or(yn(e)),
        eN = (e, t) => {
            var n;
            return 0 === e.startOffset && e.endOffset === (null === (n = t.textContent) || void 0 === n ? void 0 : n.length)
        },
        tN = (e, t) => I.from(e.getParent(t.container(), "details")),
        nN = (e, t) => tN(e, t).isSome(),
        oN = (e, t) => {
            const n = t.getNode();
        ...
        sN = (e, t, n) => {
            ...
            if ("character" === n) {
                const n = Vi.fromRangeStart(r.getRng()),
        ...
        uN = xt(),
        mN = uN.os,
        fN = mN.isMacOS() || mN.isiOS(),
        gN = uN.browser.isFirefox(),
        pN = (e, t) => {
            const n = e.dom,
        ...
        bN = e => I.from(e.dom.getParent(e.selection.getStart(!0), e.dom.isBlock)),
        vN = e => {
        ...
        xN = e => C(e) && /^(OL|UL|LI)$/.test(e.nodeName),
        EN = e => C(e) && /^(LI|DT|DD)$/.test(e.nodeName),
        _N = e => {
            const t = e.parentNode;
            return EN(t) ? t : e
        },
        ...
        ON = {
            insert: (e, t) => {
                ...
                const i = e.dom,
                    ...
                    g = f.exists((e => Vt(e) && !oo(e))),
                    p = d.collapsed && g,
                    b = (t, o) => CN(e, n, k, _, Hl(e), t, o),
                    v = e => {
                        const t = TN(e, n, o);
                    ...
                    w = () => {
                        ...
                        })(e, s) && AN(i, s) && i.isEmpty(k, void 0, {
                            includeZwsp: !0
                        }) ? t = i.split(s, k) : i.insertAfter(t, k), pN(e, t), t
                    };
                Mf(i, d).each((e => {
                ...
                x || (n = ((e, t, n, o, r) => {
                    var s, a;
                    const i = e.dom,
                        l = null !== (s = hN(i, o)) && void 0 !== s ? s : i.getRoot();
                ...
                if ("LI" !== S || E || (k = s, s = s.parentNode, r = S), qo(s) && ((e, t, n) => !t && n.nodeName.toLowerCase() === Il(e) && e.dom.isEmpty(n) && ((t, n, o) => {
                    ...
                    var o, r, s;
                    const a = t(Il(e)),
                        i = ((e, t) => e.dom.getParent(t, gr))(e, n);
                ...
                if (/^(LI|DT|DD)$/.test(r) && qo(s) && i.isEmpty(k)) return void((e, t, n, o, r) => {
                    ...
                    else if (kN(n, o, !0)) wN(n, "LI") ? (s.insertAfter(c, _N(n)), c.appendChild(s.doc.createTextNode(" ")), c.appendChild(n)) : i.insertBefore(c, n), s.remove(o);
                    else if (kN(n, o, !1)) s.insertAfter(c, _N(n)), s.remove(o);
                    else {
                        n = _N(n);
                ...
                else if (Ir(k)) R = Vr(k), i.isEmpty(k) && vN(k), yN(e, R), pN(e, R);
                else if (v(!1)) R = w();
                else if (v(!0) && N) {
        ...
        MN = e => e && "A" === e.nodeName && "href" in e,
        IN = e => e.fold(L, MN, MN, L),
        FN = (e, t) => {
        ...
        UN = {
            insert: (e, t) => {
                const n = (e => {
                    const t = T(Ch, e),
                        n = Vi.fromRangeStart(e.selection.getRng());
                ...
                n.isSome() ? n.each(T(FN, e)) : ((e, t) => {
                    ...
                    "LI" !== u || m || (d = c), er(l) && i >= l.data.length && (((e, t, n) => {
                        ...
                        for (; r = o.next();)
                            if (s[r.nodeName.toLowerCase()] || er(r) && r.length > 0) return !0;
                        return !1
        ...
        HN = (e, t) => (e => zN(e, jl(e)))(e),
        $N = e => (t, n) => (e => bN(e).filter((e => Sr(yn(e)))).isSome())(t) === e,
        qN = (e, t) => (n, o) => {
        ...
        WN = e => qN("pre", e),
        KN = e => (t, n) => Ml(t) === e,
        YN = (e, t) => (e => zN(e, zl(e)))(e),
        GN = (e, t) => t,
        XN = e => {
            const t = Il(e),
                n = hN(e.dom, e.selection.getStart());
            return C(n) && e.schema.isValidChild(n.nodeName, t)
        },
        QN = e => {
            const t = e.selection.getRng(),
                n = yn(t.startContainer),
                o = In(n, t.startOffset).map((e => Vt(e) && !oo(e)));
            return t.collapsed && o.getOr(!0)
        },
        JN = (e, t) => (n, o) => X(e, ((e, t) => e && t(n, o)), !0) ? I.some(t) : I.none(),
        ZN = (e, t, n) => {
        ...
        tR = xt(),
        nR = tR.os.isiOS() && tR.browser.isSafari(),
        oR = (e, t) => {
            var n;
        ...
        rR = xt(),
        sR = e => e.stopImmediatePropagation(),
        aR = e => e.keyCode === af.PAGE_UP || e.keyCode === af.PAGE_DOWN,
        iR = (e, t, n) => {
        ...
        mR = e => {
            const t = Vi.fromRangeStart(e.selection.getRng()),
                n = yn(e.getBody());
            if (e.selection.isCollapsed()) {
                const o = T(Ch, e),
                    r = Vi.fromRangeStart(e.selection.getRng());
                    ...
                    e.on("keydown", (t => {
                        t.isDefaultPrevented() || ((e, t) => {
                            ok([{
                                ...
                                t.preventDefault(), cN(e, "insertText", {
                                    data: " "
                                }).isDefaultPrevented() || (n(), dN(e, "insertText", {
                                    data: " "
                                }))
                            }))
                        })(e, t)
    ...
    class hR {
        constructor(e) {
            ...
            "onselectionchange" in e.getDoc() || e.on("NodeChange click mouseup keyup focus", (n => {
                ...
                t && am(e) && !n.isSameElementPath(t) && e.dom.isChildOf(t, e.getBody()) && e.nodeChanged({
                    selectionChange: !0
                })
            })), e.on("mouseup", (t => {
    ...
    const _R = ui("mode"),
        ...
        OR = TR(0),
        BR = TR(1),
        PR = ["none", "copy", "link", "move"],
        DR = ["none", "copy", "copyLink", "copyMove", "link", "linkMove", "move", "all", "uninitialized"],
        LR = () => {
            ...
            const o = {
                ...
                setDragImage: (t, n, r) => {
                    ...
                    OR(o) && (s = {
                        ...
                        x: n,
                        y: r
                    }, o[bR] = s, e.setDragImage(t, n, r))
                },
                getData: t => BR(o) ? "" : e.getData(t),
                setData: (t, n) => {
                    OR(o) && e.setData(t, n)
                },
                clearData: t => {
        ...
        tA = (e, t, n, o, r) => {
            ...
            if (!s.cancelled) {
                ...
                r ? cN(e, "insertFromPaste", {
                    dataTransfer: eA(t)
                }).isDefaultPrevented() || (n(), dN(e, "insertFromPaste")) : n()
            }
        },
        nA = (e, t, n, o) => {
            const r = n || jR(t);
        ...
        sA = (e, t) => t in e && e[t].length > 0,
        aA = e => sA(e, "text/html") || sA(e, "text/plain"),
        iA = (e, t, n) => {
        ...
        mA = e => ({
            html: zR(e.selection.getContent({
                contextual: !0
            })),
        ...
        bA = e => Pt.trim(e).replace(hA, Ca).toLowerCase(),
        vA = (e, t, n) => {
            const o = Zd(e);
    ...
    const RA = (e, t) => Math.abs(e.left - t),
        ...
        PA = (e, t, n) => ((e, t, n) => {
            const o = yn(e),
                r = Nn(o),
                s = Cn(r, t, n).filter((e => kn(o, e))).getOr(o);
            return ((e, t, n, o) => {
                const r = (t, s) => {
                ...
                if (e.dragging) {
                    const s = r.currentTarget === t.getDoc().documentElement,
                        l = ((e, t) => ({
                            ...
                            return n = (e => e.inline ? DA(e.getBody()) : {
                                left: 0,
                                top: 0
                            })(e), o = (e => {
                                const t = e.getBody();
                                ...
                                if (t.target.ownerDocument !== e.getDoc()) {
                                    const n = DA(e.getContentAreaContainer()),
                                        o = (e => {
                                            const t = e.getBody(),
        ...
        QA = dr,
        JA = (e, t) => lb(e.getBody(), t),
        ZA = e => {
            const t = e.selection,
                n = e.dom,
                o = e.getBody(),
                r = Pc(e, o, n.isBlock, (() => Rg(e))),
                s = "sel-" + n.uniqueId(),
                a = "data-mce-selected";
            let i;
                        ...
                        if (l(o)) return (o => {
                            ...
                            const d = ((o, r) => {
                                    const a = yn(e.getBody()),
                                        ...
                                        d = n.createRng();
                                    wo(l), Co(l, [vn(br, i), yn(r), vn(br, i)]), d.setStart(l.dom.firstChild, 1), d.setEnd(l.dom.lastChild, 0), lo(l, {
        ...
        iT = (e, t) => I.from(e.dom.getParent(t.startContainer, e.dom.isBlock)),
        lT = (e, t, n) => {
            ...
            return {
                ...
                inlinePatterns: wl(o).concat(e.inlinePatterns)
            }
        },
        dT = (e, t, n, o) => {
            const r = e.createRng();
        ...
        fT = (e, t, n) => {
            const o = rT(e.getRoot(), n).getOrDie("Unable to resolve path range"),
                r = o.startContainer,
                s = o.endContainer,
        ...
        xT = (e, t) => {
            ...
            return iT(e, n).map((o => {
                ...
                const s = Math.max(0, n.startOffset),
                    a = lT(t, o, null !== (r = o.textContent) && void 0 !== r ? r : ""),
                    i = CT(e, o, n.startContainer, s, a, !0),
                    l = ((e, t, n, o) => {
                        var r;
                        const s = e.dom,
                            a = Il(e);
                ...
                return (l.length > 0 || i.length > 0) && (e.undoManager.add(), e.undoManager.extra((() => {
                    ...
                    const t = e.selection.getRng(),
                        n = Bk(t.startContainer, t.startOffset, e.dom.getRoot());
        ...
        kT = za.DOM,
        ST = e => e.inline ? e.getElement().nodeName.toLowerCase() : void 0,
        NT = e => ye(e, (e => !1 === v(e))),
        RT = e => {
        ...
        TT = e => e.inline ? e.ui.styleSheetLoader : e.dom.styleSheetLoader,
        OT = e => {
            const t = TT(e),
                n = id(e),
                o = e.contentCSS,
            ...
            const a = Promise.all(((e, t, n) => {
                    const {
                        pass: o,
                        fail: r
                    } = K(t, (e => tinymce.Resource.has(Uw(e)))), s = o.map((t => {
                            ...
                            (t.inlinePatterns.length > 0 || r()) && ((e, t) => {
                                ...
                                iT(e, n).map((o => {
                                    const r = Math.max(0, n.startOffset - 1),
                                        s = dT(e.dom, o, n.startContainer, r),
                                        a = lT(t, o, s),
                                        i = CT(e, o, n.startContainer, r, a, !1);
        ...
        UT = async e => {
            e.dispatch("ScriptsLoaded"), (e => {
                const t = Pt.trim(Kl(e)),
                    n = e.ui.registry.getAll().icons,
                    o = {
                        ...xw.get("default").icons,
                        ...xw.get(t).icons
                    };
                ge(o, ((t, o) => {
                ...
                V(Ld(e), (n => {
                    ((e, t, n) => {
                        const o = Ow.get(n),
                            r = Ow.urls[n] || e.documentBaseUrl.replace(/\/$/, "");
        ...
        }, zT = za.DOM, jT = e => "-" === e.charAt(0), HT = (e, t, n) => I.from(t).filter((e => Ye(e) && !xw.has(e))).map((t => ({
            url: `${e.editorManager.baseURL}/icons/${t}/icons${n}.js`,
            name: I.some(t)
        }))), $T = (e, t) => {
            const n = Ha.ScriptLoader,
                o = () => {
                    !e.removed && (e => {
                        const t = pd(e);
            ...
            ((e, t) => {
                ...
                const o = HT(t, "default", n),
                    r = (e => I.from(Yl(e)).filter(Ye).map((e => ({
                        url: e,
                        name: I.none()
                    }))))(t).orThunk((() => HT(t, Kl(t), "")));
                V((e => {
            ...
            var s;
            const a = e ? {
                    mobile: XT(null !== (s = r.mobile) && void 0 !== s ? s : {}, t)
                } : {},
                i = YT(["mobile"], Jk(a, r)),
                l = Pt.extend(n, o, i.options(), ((e, t) => e && GT(t, "mobile"))(e, i) ? ((e, t, n = {}) => {
                    ...
                    external_plugins: QT(o, i.options())
                });
            return ((e, t, n, o) => {
                const r = KT(n.forced_plugins),
                    s = KT(o.plugins),
            ...
            "font-size": "size",
            "font-family": "face"
        }, oO = Xt("font"), rO = e => (t, n) => I.from(n).map(yn).filter(Wt).bind((n => ((e, t, n) => Lb(yn(n), (t => (t => mo(t, e).orThunk((() => oO(t) ? xe(nO, e).bind((e => tn(t, e))) : I.none())))(t)), (e => _n(yn(t), e))))(e, t, n.dom).or(((e, t) => I.from(za.DOM.getStyle(t, e, !0)))(e, n.dom)))).getOr(""), sO = rO("font-size"), aO = k((e => e.replace(/[\'\"\\]/g, "").replace(/,\s+/g, ",")), rO("font-family")), iO = e => Ou(e.getBody()).bind((e => {
            const t = e.container();
            ...
            ZT(e), (e => {
                ...
                (e => {
                    ...
                    e.editorCommands.addCommands({
                        ...
                        const n = yn(e.getBody()),
                            o = Lb(t, (e => mo(e, "line-height")), T(_n, n));
                        return o.getOrThunk((() => {
                            const e = parseFloat(co(t, "line-height")),
                                n = parseFloat(co(t, "font-size"));
                            return String(e / n)
                        }))
                    })).getOr(""))(e)))
                })(e)
    ...
    const hO = "data-mce-contenteditable",
        bO = (e, t, n) => {
            try {
                e.getDoc().execCommand(t, !1, String(n))
            } catch (e) {}
    ...
    const RO = (e, t) => {
        ...
        PO = (e, t) => e + (Ge(t.message) ? "" : `. ${t.message}`),
        DO = e => e.valid,
        LO = (e, t, n = "") => {
            const o = t(e);
            return b(o) ? o ? {
        ...
        jO = Pt.makeMap("alt,ctrl,shift,meta,access"),
        HO = e => {
            const t = {},
    ...
    class YO {
        constructor(e, t, n) {
            ...
            this.options = ((e, t) => {
                ...
                t("id", {
                    ...
                    t("directionality", {
                        ...
                        processor: "string",
                        default: kl.getAttrib(e.getElement(), "placeholder")
                    })
                }))
            })(o);
            ...
            const d = Dd(o);
            C(d) && za.DOM.styleSheetLoader._setContentCssCors(d), Ya.languageLoad = s("language_load"), Ya.baseURL = n.baseURL, this.setDirty(!1), this.documentBaseURI = new oC(Bl(o), {
                base_uri: this.baseUri
            }), this.baseURI = this.baseUri, this.inline = kd(o), this.hasVisual = Fd(o), this.shortcuts = new $O(this), this.editorCommands = new pO(this), mO(this);
        ...
        save(e = {}) {
            ...
            if (s.no_events || t.dispatch("SaveContent", s), "raw" === s.format && t.dispatch("RawSaveContent", s), r = s.content, Zo(n)) n.value = r;
            else {
        ...
        resetContent(e) {
            void 0 === e ? lw(this, this.startContent, {
                format: "raw"
            }) : lw(this, e), this.undoManager.reset(), this.setDirty(!1), this.nodeChanged()
        }
        isDirty() {
        ...
        remove() {
            (e => {
                if (!e.removed) {
                    ...
                    o && e.save({
                        is_removing: !0
                    }), e.removed = !0, e.unbindAllNativeEvents(), e.hasHiddenInput && C(null == r ? void 0 : r.nextSibling) && Cw.remove(r.nextSibling), (e => {
                        e.dispatch("remove")
    ...
    const eB = e => {
        ...
        oB = "CSS1Compat" !== document.compatMode,
        rB = {
            ...kO,
            baseURI: null,
            baseURL: null,
            ...
            add(e) {
                const t = this,
                    n = t.get(e.id);
                return n === e || (null === n && ZO.push(e), tB(!0), t.activeEditor = e, t.dispatch("AddEditor", {
                    editor: e
                }), QO || (QO = e => {
            ...
            remove(e) {
                ...
                let n;
                if (e) {
                    if (!m(e)) return n = e, h(t.get(n.id)) ? null : (nB(n) && t.dispatch("RemoveEditor", {
                        editor: n
                    }), 0 === ZO.length && window.removeEventListener("beforeunload", QO), n.remove(), tB(ZO.length > 0), n);
                    XO(GO.select(e), (e => {
                        n = t.get(e.id), n && t.remove(n)
                    }))
                } else
                    for (let e = ZO.length - 1; e >= 0; e--) t.remove(ZO[e])
            },
            execCommand(e, t, n) {
                var o;
                const r = this,
    ...
    const sB = (() => {
        ...
        uB = {
            ...
            intersect: (e, t) => {
                const n = iB(e.x, t.x),
                    o = iB(e.y, t.y),
                    r = aB(e.x + e.w, t.x + t.w),
                    s = aB(e.y + e.h, t.y + t.h);
            ...
            util: {
                ...
                ImageUploader: e => {
                    const t = Hw(),
                        n = Ww(e, t);
                    return {
                        upload: (t, o = !0) => n.upload(t, o ? Vw(e) : void 0)
                    }
                }
            },
            dom: {
